...
public class JListRenderer extends JLabel implements ListCellRenderer<Object>
{
	...
	private Color background = ZPLCommon.color_listBackground;
	private JSeparator separator;

	public JListRenderer()
	{
		separator = new JSeparator(JSeparator.HORIZONTAL);
		setFont(ZPLCommon.font_list);
	}
	...
	{
		{
			...
			renderer.setFont(ZPLCommon.font_list);
			...
			if (!isSelected)
			{
				...
				renderer.setForeground(ZPLCommon.color_listFontSelected);
			} else
			{
				renderer.setBackground(ZPLCommon.color_listHighlighted);
				renderer.setForeground(ZPLCommon.color_listFontStandard);
			}
