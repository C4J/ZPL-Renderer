...
import com.commander4j.zpl.ZPLFrame;
...
public class JLicenseInfo implements Comparable<JLicenseInfo>
{
	...
	public LinkedList<JLicenseInfo> getLicences()
	{
		...
		JLicenseInfo test = new JLicenseInfo("ZPLRenderer","GNU General Public License V2.txt",ZPLFrame.version,"GNU General Public License V2");
